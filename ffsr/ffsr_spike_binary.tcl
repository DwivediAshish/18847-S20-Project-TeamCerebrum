analyze -library WORK -format sverilog {../ffsr_spike_binary.sv}

elaborate ffsr_spike_binary -architecture verilog -library WORK
...
report_area              > ../simresults/ffsr_spike_binary.area
report_power             > ../simresults/ffsr_spike_binary.pow
report_cell              > ../simresults/ffsr_spike_binary.cell
report_timing -nworst 3  > ../simresults/ffsr_spike_binary.tim
