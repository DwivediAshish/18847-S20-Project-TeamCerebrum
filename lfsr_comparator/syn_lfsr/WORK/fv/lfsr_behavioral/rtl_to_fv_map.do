...
# Generated on: Wed May 06 17:59:44 EDT 2020 (Wed May 06 21:59:44 GMT 2020)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/lfsr_behavioral/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/lfsr_behavioral -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../../rtl/lfsr/lfsr.sv ../../rtl/lfsr/lfsr_behavioral.sv ../../rtl/lfsr/prob_gen.sv
elaborate_design -golden -root {lfsr_behavioral} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/lfsr_behavioral/fv_map.v.gz
...
#add_name_alias fv/lfsr_behavioral/fv_map.singlebit.original_name.alias.json.gz -revised
