...
read_hdl -language sv "lfsr.sv lfsr_behavioral.sv prob_gen.sv comp_pulse.sv comp_output_sel.sv comp_pulse_another_design.sv register.sv"
elaborate $DESIGN
