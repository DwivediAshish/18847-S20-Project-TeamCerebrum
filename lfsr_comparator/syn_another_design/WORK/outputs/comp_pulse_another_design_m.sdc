...
#  Created by Genus(TM) Synthesis Solution 18.14-s037_1 on Thu Apr 30 14:24:40 EDT 2020
...
current_design comp_pulse_another_design

group_path -weight 1.000000 -name C2C -from [list \
  [get_cells {comp_edge_inst/comp_edge_resolve_inst/to_sel_mux_reg[0]}]  \
  [get_cells comp_pulse_edge_inst/x_edge_reg]  \
  [get_cells comp_pulse_edge_inst/y_edge_reg] ] -to [list \
  [get_cells {comp_edge_inst/comp_edge_resolve_inst/to_sel_mux_reg[0]}]  \
  [get_cells comp_pulse_edge_inst/x_edge_reg]  \
  [get_cells comp_pulse_edge_inst/y_edge_reg] ]
