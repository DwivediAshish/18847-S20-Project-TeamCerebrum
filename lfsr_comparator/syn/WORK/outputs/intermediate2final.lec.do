...
# Generated on: Thu Apr 30 14:27:15 EDT 2020 (Thu Apr 30 18:27:15 GMT 2020)
...
set_verification_information fv_map_comp_pulse_mv_db

read_implementation_information fv/comp_pulse -golden fv_map -revised comp_pulse_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/comp_pulse/fv_map.v.gz
elaborate_design -golden -root {comp_pulse}

read_design -verilog95   -revised -lastmod -noelab outputs/comp_pulse_m.v
elaborate_design -revised -root {comp_pulse}

#add_name_alias fv/comp_pulse/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/comp_pulse/comp_pulse_mv.singlebit.original_name.alias.json.gz -revised
