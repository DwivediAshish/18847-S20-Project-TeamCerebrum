...
# Generated on: Thu Apr 30 14:22:27 EDT 2020 (Thu Apr 30 18:22:27 GMT 2020)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/comp_edge/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/comp_edge -revised fv_map
...
add_search_path . ../../rtl ../../rtl/comp_edge ../../rtl/comp_pulse ../../rtl/lfsr -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../../rtl/comp_edge/comp_edge_resolve.sv ../../rtl/comp_edge/edge_sel.sv ../../rtl/comp_edge/comp_edge.sv
elaborate_design -golden -root {comp_edge} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/comp_edge/fv_map.v.gz
elaborate_design -revised -root {comp_edge}
...
#add_name_alias fv/comp_edge/fv_map.singlebit.original_name.alias.json.gz -revised
