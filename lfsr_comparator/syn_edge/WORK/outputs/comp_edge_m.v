...
// Generated on: Apr 30 2020 14:22:29 EDT (Apr 30 2020 18:22:29 UTC)

// Verification Directory fv/comp_edge 
...
module edge_sel(cases, u_capture, u_minus, u_search, u_backoff, prob,
  ...
  NAND2XL g609__8780(.A (n_12), .B (n_21), .Y (prob[6]));
  NAND2XL g610__4296(.A (n_10), .B (n_8), .Y (prob[5]));
  NAND2XL g611__3772(.A (n_18), .B (n_15), .Y (prob[4]));
  NAND2XL g612__1474(.A (n_11), .B (n_13), .Y (prob[3]));
  NAND2XL g613__4547(.A (n_16), .B (n_17), .Y (prob[0]));
  NAND2XL g614__9682(.A (n_19), .B (n_20), .Y (prob[1]));
  ...
  NOR2X2 g631__5795(.A (n_2), .B (cases[0]), .Y (n_6));
  NOR2X2 g633__7344(.A (n_3), .B (cases[0]), .Y (n_5));
  NOR2X2 g634__1840(.A (n_1), .B (cases[0]), .Y (n_4));
