...
# Generated on: Thu Apr 30 14:22:30 EDT 2020 (Thu Apr 30 18:22:30 GMT 2020)
...
set_verification_information fv_map_comp_edge_mv_db

read_implementation_information fv/comp_edge -golden fv_map -revised comp_edge_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/comp_edge/fv_map.v.gz
elaborate_design -golden -root {comp_edge}

read_design -verilog95   -revised -lastmod -noelab outputs/comp_edge_m.v
elaborate_design -revised -root {comp_edge}

#add_name_alias fv/comp_edge/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/comp_edge/comp_edge_mv.singlebit.original_name.alias.json.gz -revised
